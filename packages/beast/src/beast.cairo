...
use death_mountain_beast::constants::BeastId::{Bear, Fairy, Gnome, MAX_ID, Troll};
use death_mountain_beast::constants::BeastSettings::{
...
use death_mountain_combat::constants::CombatEnums::{Tier, Type};
