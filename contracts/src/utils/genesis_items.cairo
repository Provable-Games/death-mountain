...
pub fn get_genesis_items_data() -> Array<GenesisItemData> {
    ...
    items
        .append(
            GenesisItemData { id: ItemId::BrightsilkSash, name: 'Brightsilk Sash', tier: 1, item_type: 1, slot: 4 },
        );
    ...
    items
        .append(
            GenesisItemData { id: ItemId::DivineSlippers, name: 'Divine Slippers', tier: 1, item_type: 1, slot: 5 },
        );
    ...
    items
        .append(
            GenesisItemData { id: ItemId::DragonskinArmor, name: 'Dragonskin Armor', tier: 2, item_type: 2, slot: 2 },
        );
    items
        .append(
            GenesisItemData {
                id: ItemId::StuddedLeatherArmor, name: 'Studded Leather Armor', tier: 3, item_type: 2, slot: 2,
            },
        );
    items
        .append(
            GenesisItemData {
                id: ItemId::HardLeatherArmor, name: 'Hard Leather Armor', tier: 4, item_type: 2, slot: 2,
            },
        );
    ...
    items
        .append(
            GenesisItemData { id: ItemId::DragonskinBelt, name: 'Dragonskin Belt', tier: 2, item_type: 2, slot: 4 },
        );
    items
        .append(
            GenesisItemData {
                id: ItemId::StuddedLeatherBelt, name: 'Studded Leather Belt', tier: 3, item_type: 2, slot: 4,
            },
        );
    items
        .append(
            GenesisItemData { id: ItemId::HardLeatherBelt, name: 'Hard Leather Belt', tier: 4, item_type: 2, slot: 4 },
        );
    ...
    items
        .append(
            GenesisItemData { id: ItemId::DemonhideBoots, name: 'Demonhide Boots', tier: 1, item_type: 2, slot: 5 },
        );
    items
        .append(
            GenesisItemData { id: ItemId::DragonskinBoots, name: 'Dragonskin Boots', tier: 2, item_type: 2, slot: 5 },
        );
    items
        .append(
            GenesisItemData {
                id: ItemId::StuddedLeatherBoots, name: 'Studded Leather Boots', tier: 3, item_type: 2, slot: 5,
            },
        );
    items
        .append(
            GenesisItemData {
                id: ItemId::HardLeatherBoots, name: 'Hard Leather Boots', tier: 4, item_type: 2, slot: 5,
            },
        );
    ...
    items
        .append(
            GenesisItemData { id: ItemId::DragonskinGloves, name: 'Dragonskin Gloves', tier: 2, item_type: 2, slot: 6 },
        );
    items
        .append(
            GenesisItemData {
                id: ItemId::StuddedLeatherGloves, name: 'Studded Leather Gloves', tier: 3, item_type: 2, slot: 6,
            },
        );
    items
        .append(
            GenesisItemData {
                id: ItemId::HardLeatherGloves, name: 'Hard Leather Gloves', tier: 4, item_type: 2, slot: 6,
            },
        );
    ...
    items
        .append(
            GenesisItemData { id: ItemId::HolyChestplate, name: 'Holy Chestplate', tier: 1, item_type: 3, slot: 2 },
        );
    items
        .append(
            GenesisItemData { id: ItemId::OrnateChestplate, name: 'Ornate Chestplate', tier: 2, item_type: 3, slot: 2 },
        );
    ...
    items
        .append(
            GenesisItemData { id: ItemId::OrnateGauntlets, name: 'Ornate Gauntlets', tier: 2, item_type: 3, slot: 6 },
        );
